    ...
    var StewardClientService = (function () {
         ...
         */
            function (endpoint, data) {
                ...
                return this.http.post(this.base_url + endpoint, formData, { headers: new http.HttpHeaders({ 'Authorization': 'Bearer ' + this.config.access_token }) }).pipe(operators.catchError(this.handleError()));
            };
        /**
         * @param {?} data
         * @return {?}
